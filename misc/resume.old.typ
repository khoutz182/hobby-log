...
#resume-item[
  ...
  - Migrated a suite of backend rest services from Java 1.8 to Java 11, as well as from Guice+Resteasy to Spring Boot
  - Configured newly-converted Spring Boot applications to run on ECS, rather than Elastic Beanstalk
]
